...
/**
 * is_strcpy - copies a string to another. destination needs to be malloc'd
...
/**
 * is_strdup - duplicates a string, allocating the appropriate size to the copy
